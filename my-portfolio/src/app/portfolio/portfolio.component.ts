...
export class PortfolioComponent {
  ...
  projects: Card[] = [
    {
      id: 1,
      name: 'Collect Co',
      summary: "CollectCo is an online debt recovery platform that helps businesses recover unpaid invoices through automated, compliant, and transparent collection processes.",
      description: "CollectCo offers flat-fee and contingency-based debt collection services for businesses. It features a smart dashboard, automated outreach, and consumer-friendly tools to simplify and speed up the recovery of overdue payments.",
      projectLink: 'https://collectco.com/',
      tags: [Tag.Wordpress, Tag.Elemontor],
      
      pictures: ["../../assets/Collect.png", "../../assets/CollectCO.png"]
    },
    {
      id: 2,
      name: 'Remote Scouts',
      summary: "Remote Scouts is a remote staffing agency (by Cedar Global Solutions) that helps companies hire pre-screened offshore and nearshore professionals across roles like web, IT, marketing, and back-office services—offering cost savings of up to 40% and fast onboarding.",
      description: "Remote Scouts simplifies remote hiring by sourcing, vetting, and integrating global talent into your team. Serving startups to enterprises, it covers technical and non-technical roles—including software development, design, SEO, BPO, medical billing, and more—with transparent pricing and flexible staffing models.",
      projectLink: 'https://remotescouts.com/',
      tags: [Tag.Wordpress, Tag.Elemontor, Tag.AvadaBuilder],
      pictures: ["../../assests/RS.png", "../../assets/R.S.png", "../../assets/Remote.png"]
    },
    {
      id: 3,
      name: 'Haveli Mian Abdul Karim Sethi',
      summary: 'Haveli Mian Abdul Karim Sethi is a newly opened cultural museum housed in the historic ancestral mansion of the Sethi family, located in Peshawar’s old walled city.',
      description: 'This heritage haveli has been restored and adapted into a museum focused on preserving and displaying the history of the prominent Sethi family of Peshawar. It features period furnishings and cultural artifacts, supports public tours and events, and includes an on-site shop selling themed souvenirs such as postcards and mugs.',
      projectLink: 'https://havelimianabdulkarimsethi.com/',
      tags: [Tag.Wordpress, Tag.Elemontor,],
      pictures: ["../../assets/MAKS.png", "../../assets/MKS.png", "../../assets/MAS.png"]
    },
    // {
    //   id: 4,
  ...
  constructor(private titleService: Title) {
    this.titleService.setTitle('MB| Portfolio')
  }
